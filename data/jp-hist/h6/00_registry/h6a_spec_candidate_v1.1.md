# H6-A External Shock Robustness — Spec Candidate v1.1（待复审）
版本：2026-09-07 v1.1 candidate（A0 v1.0 外审 REWORK 后修订）
状态：candidate——外部复审 PASS 后提升为 FROZEN；本文件签署前不用于数据下载/计算。
元数据：spec_version=v1.1-candidate；freeze_date=2026-09-07；parent=v1.0（REWORK，见 01_数据采集/外部审核意见/JP-HIST_H6A0_Spec_外部审核意见_20260907.md）；sha256 见 audit_package_v1.1 manifest。

## 0. 决策记录（追加制）
- 2026-09-07 v1.0 FROZEN（用户「按默认执行」）。
- 2026-09-07 外审 REWORK：P0×3/P1×5/P2×4（不冻结、不启动 A1）。
- 2026-09-07 v1.1 candidate 修订：P0-1 修复 registry（13 列全行一致+机器 QC）；P0-2 删除 confirmatory 模型趋势项（趋势项仅作 Model T diagnostic，不进 Gate）；P0-3 新增 h6a_event_operation_matrix（E01-E06×country×LEO 机器矩阵）；P1-1 Gate A1/A2 机器化；P1-2 Gate A3 加 effect floor；P1-3 VIX common-support 冻结（方案 1）；P1-4/P1-5 语义与 event-time anchor 修订见 H6-B spec；P2-1..4 见下。v1.0 文件保持只读。
