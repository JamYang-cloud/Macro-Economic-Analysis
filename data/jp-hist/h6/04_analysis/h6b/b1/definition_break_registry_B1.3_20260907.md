# H6-B B1 — Definition Break Registry（FROZEN 版，B1.3 freeze-closure 定名）

日期：2026-09-07（B1.1 data-correction patch 后重建；B1.3 定名）
版本沿革：B1.1（2026-09-07 初版）→ B1.2（补充登记 4 项）→ **B1.3（freeze-closure 定名，内容同 B1.2）**
依据：JP-HIST_H6B_B1_GATE1 审核报告 §17（definition_break_registry 重生成）+ B1.2 外审 §12（P2: 文件版本名对齐）
